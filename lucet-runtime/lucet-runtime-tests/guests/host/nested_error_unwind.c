...
extern uint64_t restore_callee_saved(uint64_t (*)(void));
extern void     hostcall_panic();

uint64_t callback_restore(void)
{
    uint64_t a = 0xFFFFFFFF00000000;
    uint64_t b = 0xFFFFFFFF00000001;
    uint64_t c = 0xFFFFFFFF00000002;
...
uint64_t entrypoint_restore(void) {
    return restore_callee_saved(callback_restore);
}
