...
#[test]
fn hello() {
    let ctx = WasiCtxBuilder::new().args(["hello"].iter());
...
#[test]
fn hello_args() {
    let ctx = WasiCtxBuilder::new().args(["hello", "test suite"].iter());
...
#[test]
fn poll() {
    let ctx = WasiCtxBuilder::new().args(["poll"].iter());
