...
static const unsigned char CASE_MAP[] = {
    ...
    '\074', '\075', '\076', '\077', '\100', '\141', '\142', '\143', '\144', '\145', '\146', '\147',
    '\150', '\151', '\152', '\153', '\154', '\155', '\156', '\157', '\160', '\161', '\162', '\163',
    '\164', '\165', '\166', '\167', '\170', '\171', '\172', '\133', '\134', '\135', '\136', '\137',
...
guest_int builtin_strcasecmp(const struct lucet_vmctx *ctx, guest_ptr_t a_off_, guest_ptr_t b_off_)
{
    ...
    while (CASE_MAP[(unsigned char) heap[a_off]] == CASE_MAP[(unsigned char) heap[b_off]]) {
        if (heap[a_off] == 0) {
            return 0;
        }
        a_off++;
    ...
    return (guest_int)(CASE_MAP[(unsigned char) heap[a_off]] -
                       CASE_MAP[(unsigned char) heap[b_off]]);
}
