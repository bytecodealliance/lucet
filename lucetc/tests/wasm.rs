...
fn load_wat_module(name: &str, options: LoadOptions) -> Vec<u8> {
    use std::fs::File;
    use std::io::Read;
    use wabt::Wat2Wasm;
    ...
    if options.write_debug_names {
        wat2wasm.write_debug_names(true);
    }
    wat2wasm
        .convert(contents)
...
mod module_data {
    ...
    use super::{load_wat_module, LoadOptions};
    use lucet_module::bindings::Bindings;
    use lucetc::{Compiler, CpuFeatures, HeapSettings, LucetcErrorKind, OptLevel};
    use std::path::PathBuf;

    #[test]
    fn exported_import() {
        let m = load_wat_module("exported_import", LoadOptions::default());
    ...
    #[test]
    fn multiple_import() {
        let m = load_wat_module("multiple_import", LoadOptions::default());
        let b = super::test_bindings();
        let h = HeapSettings::default();
        let c = Compiler::new(
            &m,
    ...
    #[test]
    fn globals_export() {
        let m = load_wat_module("globals_export", LoadOptions::default());
        let b = super::test_bindings();
        let h = HeapSettings::default();
        let c = Compiler::new(
            &m,
    ...
    #[test]
    fn fibonacci() {
        let m = load_wat_module("fibonacci", LoadOptions::default());
        let b = super::test_bindings();
        let h = HeapSettings::default();
        let c = Compiler::new(
            &m,
    ...
    #[test]
    fn arith() {
        let m = load_wat_module("arith", LoadOptions::default());
    ...
    fn duplicate_imports() {
        let m = load_wat_module("duplicate_imports", LoadOptions::default());
    ...
    #[test]
    fn icall_import() {
        let m = load_wat_module("icall_import", LoadOptions::default());
        let b = Bindings::from_file(&PathBuf::from(
    ...
    #[test]
    fn icall() {
        let m = load_wat_module("icall", LoadOptions::default());
        let b = Bindings::empty();
        let h = HeapSettings::default();
        let c = Compiler::new(
            &m,
    ...
    #[test]
    fn icall_sparse() {
        let m = load_wat_module("icall_sparse", LoadOptions::default());
        let b = Bindings::empty();
        let h = HeapSettings::default();
        let c = Compiler::new(
            &m,
    ...
    fn globals_import() {
        ...
        let m = load_wat_module("globals_import", LoadOptions::default());
        let b = Bindings::empty();
        let h = HeapSettings::default();
    ...
    fn heap_spec_import() {
        ...
        let m = load_wat_module("heap_spec_import", LoadOptions::default());
        let b = Bindings::empty();
        let h = HeapSettings::default();
        let c = Compiler::new(
            &m,
    ...
    fn heap_spec_definition() {
        use lucet_module::HeapSpec;
        let m = load_wat_module("heap_spec_definition", LoadOptions::default());
        let b = Bindings::empty();
        let h = HeapSettings::default();
        let c = Compiler::new(
            &m,
    ...
    #[test]
    fn heap_spec_none() {
        let m = load_wat_module("heap_spec_none", LoadOptions::default());
        let b = Bindings::empty();
        let h = HeapSettings::default();
        let c = Compiler::new(
            &m,
    ...
    fn oversize_data_segment() {
        let m = load_wat_module("oversize_data_segment", LoadOptions::default());
        let b = Bindings::empty();
        let h = HeapSettings::default();
        let c = Compiler::new(
            &m,
    ...
    #[test]
    fn start_section() {
        let m = load_wat_module("start_section", LoadOptions::default());
        let b = Bindings::empty();
        let h = HeapSettings::default();
        let _c = Compiler::new(
            &m,
...
mod compile {
    ...
    fn run_compile_test(file: &str) {
        let m = load_wat_module(file, LoadOptions::default());
        let b = super::test_bindings();
        let h = HeapSettings::default();
        let c = Compiler::new(
            &m,
...
mod validate {
    ...
    #[test]
    fn validate_import() {
        let m = load_wat_module("import", LoadOptions::default());
        let b = super::test_bindings();
        let h = HeapSettings::default();
    ...
    fn validate_import_many() {
        let m = load_wat_module("import_many", LoadOptions::default());
        let b = super::test_bindings();
        let h = HeapSettings::default();
    ...
    fn validate_wasi_exe() {
        let m = load_wat_module("wasi_exe", LoadOptions::default());
        let b = super::test_bindings();
        let h = HeapSettings::default();
